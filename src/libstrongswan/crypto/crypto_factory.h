...
#ifdef QSKE
/**
 * Create an enumerator over all registered quantum-safe groups.
 *
 * @return				enumerator over quantum_safe_group_t, plugin
 */
enumerator_t* (*create_qs_enumerator)(crypto_factory_t *this);
#endif
