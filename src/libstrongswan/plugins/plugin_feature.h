...
#ifdef QSKE
#define _PLUGIN_FEATURE_QS(kind, group)						__PLUGIN_FEATURE(kind, QS, .qs_group = group)
#endif
...
#ifdef QSKE
#define _PLUGIN_FEATURE_REGISTER_QS(type, f)				__PLUGIN_FEATURE_REGISTER(type, f)
#endif
