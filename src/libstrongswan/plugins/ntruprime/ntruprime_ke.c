...
#define METHOD_KE(name, ret, ...) METHOD(diffie_hellman_t, name, ret, private_ntruprime_ke_t *this, ##__VA_ARGS__)

typedef struct private_ntruprime_ke_t private_ntruprime_ke_t;

 /**
 * Private data of an ntruprime_ke_t object.
 */
struct private_ntruprime_ke_t {
	/**
	 * Public ntruprime_ke_t interface.
	 */
	ntruprime_ke_t public;
