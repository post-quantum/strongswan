...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"RADIUS_ATTRIBUTE");
#ifdef QSKE
ENUM_NEXT(notify_type_names, INVALID_QSKE_PAYLOAD, INVALID_QSKE_PAYLOAD, RADIUS_ATTRIBUTE,
	"INVALID_QSKE_PAYLOAD",
);
ENUM_END(notify_type_names, INVALID_QSKE_PAYLOAD);
#else
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"RADIUS");
#ifdef QSKE
ENUM_NEXT(notify_type_short_names, INVALID_QSKE_PAYLOAD, INVALID_QSKE_PAYLOAD, RADIUS_ATTRIBUTE,
	"INVAL_QSKE");
ENUM_END(notify_type_short_names, INVALID_QSKE_PAYLOAD);
#else
